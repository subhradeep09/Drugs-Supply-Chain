...
const mockDeliveries = [
  { orderId: 'ORD001', drug: 'Paracetamol 500mg', quantity: 100, status: 'Pending' },
  { orderId: 'ORD002', drug: 'Amoxicillin 250mg', quantity: 50, status: 'Pending' },
  { orderId: 'ORD003', drug: 'Ibuprofen 400mg', quantity: 75, status: 'Pending' },
];
