 ...
 <div className="bg-gradient-to-r from-red-600 to-blue-600 rounded-xl shadow-md p-6 mb-8">
  <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
    <div className="text-white">
      ...
      <p className="text-blue-100 mt-2">Manage and track all pharmacy medication requests</p>
    </div>
    <div className="flex flex-col sm:flex-row gap-3 mt-4 md:mt-0 w-full md:w-auto">
      <div className="relative w-full sm:w-64">
        ...
        <input
          ...
          className="block w-full pl-10 pr-3 py-2 border border-blue-400 rounded-lg bg-white bg-opacity-90 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent"
          value={searchTerm}
      ...
      <div className="relative w-full sm:w-48">
        ...
        <select
          className="block w-full pl-10 pr-3 py-2 border border-blue-400 rounded-lg bg-white bg-opacity-90 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 focus:border-transparent appearance-none"
          value={statusFilter}
                ...
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <div className="flex items-center">
                      <FaClinicMedical className="mr-2" /> Pharmacy
                    </div>
                  </th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                    <div className="flex items-center">
